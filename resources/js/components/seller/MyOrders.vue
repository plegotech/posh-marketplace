                    ...
                    <!-- START: FIRST TAB CONTENT -->
                            <div id="first-pvs-posh" class="top-newOrder">
                                ...
                                <table class="table" id="pvs-tab">
                                    <thead>
                                    <tr>
                                        <th class="shuffle-bx" scope="col" @click=""><span class="sort-ad">Order Id <img class="shuffle"
                                                                                                                                                             src="/img/shuffle.png"></span>
                                        </th>
                                        <th class="shuffle-bx" scope="col" @click=""><span class="sort-ad">Recipient <img class="shuffle"
                                                                                                                                                           src="/img/shuffle.png"></span>
                                        </th>
                                        <th class="shuffle-bx" scope="col" @click=""><span class="sort-ad">Delivery Date <img class="shuffle"
                                                                                                                                                           src="/img/shuffle.png"></span>
                                        </th>
