        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content p-4">
                    <img :src="'/img/seller-logos/'+ company.logo" style="max-width: 150px; height: auto"
                         alt="">
                    <form ref="form">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="top-newOrder">
                    ...
                    <table class="table">
                        ...
                        <tr v-for="company in companies" v-bind="company.id">
                            <td>
                                <img :src="'/img/seller-logos/'+ company.logo" alt="">
...
export default {
    ...
    methods: {
        ...
        exportCompanies() {
            window.open('/api/export-companies/seller', '_blank').focus()
        },
