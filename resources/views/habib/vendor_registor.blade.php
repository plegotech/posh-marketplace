                            ...
                            <div class="registration-dvs-form text-center">
                                ...
                                <form>
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <input id="Subscription Fees" name="Subscription Fees"
                                                   placeholder="Subscription Fees*" class="form-control" type="text">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input id="Email Address" name="Email Address" placeholder="Email Address*"
