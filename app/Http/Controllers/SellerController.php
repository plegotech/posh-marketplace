...
>>>>>>> 7e7aa67 (Revert "Revert "Updated Bugs"")
    ...
    public function seller(Request $request, $step)
    {
        ...
        if ($step == 'tier') {
            ...
            SellerWebsite::updateOrCreate(
                array('seller_id' => $request->input('seller_id')),
    ...
    public function soldStatistics(
        $seller_id,
        $order_by = 'id',
        $order = 'desc',
        $month = 0,
    ...
    public function dashboard($id)
    {
        ...
        $stats = OrderItems::select(
            DB::raw('(' . $sql . ' order_items.status = "approved" AND order_items.progress != "delivered") as total_orders'),
